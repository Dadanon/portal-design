<template>
  ...
  <el-row style="margin: 10px">
    <el-col :span="1"
      ><div class="grid-content">
        <el-image :src="icon_adres_01" /></div
    ></el-col>
    <el-col :span="23"
      ><div class="grid-content" style="height: 100%; align-content: center">
        <el-button type="text" style="color: black"
          >&nbsp;Посмотреть на карте<el-icon><DArrowRight /></el-icon
        ></el-button></div
    ></el-col>
  </el-row>
  <el-button type="primary" class="normal_but" disabled>Вступить в группу проекта</el-button>
  <span> (Доступно зарегистрированным пользователям)</span>
  <el-row>
    <el-col :span="24"
      ><div class="grid-content border_top">
  ...
  <el-row class="margin_but_10">
    <el-col :xs="2" :sm="2" :md="2" :lg="1" :xl="1" class="border_right">
      <el-button-group>
        ...
        <el-tooltip class="box-item" effect="dark" content="Ответить" placement="bottom-start">
          <el-button type="text" plain :icon="Back" />
        </el-tooltip>
        <el-tooltip class="box-item" effect="dark" content="Цитировать" placement="bottom-start">
  ...
  <el-row class="margin_but_10">
    ...
    <el-col :xs="21" :sm="21" :md="21" :lg="22" :xl="22" class="under_line">
      <span class="txt_in_message margin_left_10"> Ответное сообщение пользователя </span>
    </el-col>
  </el-row>
  ...
  <el-row>
    <el-col>
      <el-button type="primary" class="normal_but" @click="$router.push('/root_see_prez_comment')"
        >Перейти на страницу комментариев</el-button
      >
    </el-col>
  </el-row>
</template>
...
const open_edit_ban_prg = () => {
  ElMessageBox.prompt(
    'Здесь в отдельных полях название проекта и краткое описание',
