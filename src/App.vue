...
<el-menu
              ...
              >
                 ...
                 <el-menu-item index="/up_newprg">
                  ...
                  <el-menu-item-group> <template #title class="name_group_in_menu"><el-icon><Location /></el-icon> Выбрать проект для редактирования:</template>
 ...
 <el-row class="u_header" align="top">
    <el-col :span="4" class="port_logo"><div class="grid-content">
      <el-image :src="url_logo" :fit="fit" />
    </div></el-col>
    <el-col :span="20" class="port_title"><div class="grid-content">
 ...
 <el-affix :offset="0">
    <el-row align="middle" justify="end" class="head_line">
        <el-col :xs="4" :sm="4" :md="19" :lg="19" :xl="19"><div class="grid-content hidden-sm-and-down" >
          ...
          >
              <el-button type="text" :icon="HomeFilled" @click="$router.push('/')" style="color: black" />
          </el-tooltip>
            <el-button class="top_menu_but" type="text" @click="$router.push('/root_allpeople')" style="color: black">Сообщества</el-button>
            <el-button class="top_menu_but" type="text" @click="$router.push('/root_listprg')" style="color: black">Проекты</el-button>
            <el-button class="top_menu_but" type="text" @click="$router.push('/root_request')" style="color: black">Запросы</el-button>
            <el-button class="top_menu_but" type="text" @click="$router.push('/root_tender')" style="color: black">Предложения</el-button>
            <el-button class="top_menu_but" :icon="Location" type="text" @click="$router.push('/up_command')" style="color: black">Карта</el-button>
          </el-button-group>
        </div></el-col>
        <el-col :xs="9" :sm="8" :md="5" :lg="5" :xl="5"><div class="grid-content head_line_but">
          <el-tooltip
            class="box-item"
            effect="dark"
            content="Избранное"
            placement="bottom-start"
          >
            <el-button type="default" circle="true" class="head_but" :icon="Star" @click="$router.push('/root_like')" />          
        </el-tooltip>
        <el-tooltip
            class="box-item"
            effect="dark"
            ...
            placement="bottom-start"
          >        
            <el-button type="default" circle="true" class="head_but" :icon="QuestionFilled" @click="$router.push('/root_help')" />          
          </el-tooltip>
          <el-tooltip
            class="box-item"
            effect="dark"
 ...
 <el-row class="u_footer_row1">
    <el-col :span="24"><div class="grid-content">
      <span class="txt_wight"><el-icon><Message /></el-icon>&nbsp;info@urbanset.ru</span>
    </div></el-col>
 </el-row>  

 <el-row class="u_footer_row2">
    <el-col :span="8"><div class="grid-content">
      <span class="txt_gray">Ссылки на презентации всех проектов в html и выпадающем спмске(?)</span>
    </div></el-col>
    <el-col :span="8"><div class="grid-content">
      <span class="txt_gray">Ссылки на презентации всех запросов в html и выпадающем спмске(?)</span>
    </div></el-col>
    <el-col :span="8"><div class="grid-content">
      <span class="txt_gray">Ссылки на презентации всех предложений в html и выпадающем спмске(?)</span>
    </div></el-col>        
 </el-row>  
